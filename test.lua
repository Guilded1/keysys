...
local getChar2 = function()
    local Character = getgenv().plr.Character
    if Character then
        return Character
    else
        Player.CharacterAdded:Wait()
...
local Window = Rayfield:CreateWindow({
   Name = "Global TAS",LoadingTitle = "\"rahh\"",LoadingSubtitle = "by relevant500",
   ConfigurationSaving = {Enabled = true,FolderName="tomato.txt",FileName="Global TAS by relevant500"},
   Discord = {Enabled = false,Invite="8N2M9fHJqa",RememberJoins=true},KeySystem = false,KeySettings = {Title="",Subtitle="",Note="",FileName="",SaveKey=true,GrabKeyFromSite=false,Key={""}}
})
